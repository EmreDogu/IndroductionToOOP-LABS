	...
	protected boolean canMove(Piece toPiece, Piece fromPiece, Square toSquare, Square fromSquare) {
		if(toPiece==null || toPiece.getColor()!=fromPiece.getColor()) {
			if(ChessBoard.BetweenisEmpty(fromSquare, toSquare)) {
					return true;
			}if(((Math.abs(fromSquare.getRow() - toSquare.getRow()) == 1 && Math.abs(toSquare.getCol() - fromSquare.getCol()) == 0) || (Math.abs(fromSquare.getRow() - toSquare.getRow()) == 0 && Math.abs(toSquare.getCol() - fromSquare.getCol()) == 1)) || ((Math.abs(fromSquare.getRow() - toSquare.getRow()) == 1 && Math.abs(toSquare.getCol() - fromSquare.getCol()) == 1))) {
				return true;
			}
		}
		return false;
